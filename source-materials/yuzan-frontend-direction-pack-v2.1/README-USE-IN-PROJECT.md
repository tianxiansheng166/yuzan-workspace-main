...
/home/admin01/Documents/yuzan-workspace-main/yuzan-next/
  source-materials/frontend-design/yuzan-frontend-direction-pack-v2.1/
```
...
```bash
bash source-materials/frontend-design/yuzan-frontend-direction-pack-v2.1/scripts/project-preflight.sh
bash source-materials/frontend-design/yuzan-frontend-direction-pack-v2.1/scripts/snapshot-web-interface.sh \
...
```bash
bash source-materials/frontend-design/yuzan-frontend-direction-pack-v2.1/scripts/verify-web-interface.sh \
  . .local/interface-baseline/<stream>
```
