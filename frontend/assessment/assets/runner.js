(() => {
  ...
  const state = { attempt: null, items: [], currentIndex: 0, save: 'IDLE', error: '', timers: new Map(), saves: new Map(), media: null, blob: null, blobUrl: null, recordingIdempotencyKey: null, elapsed: 0, resourceUrls: new Map(), resourceErrors: new Map(), resolvingResources: new Set(), feedbackOpen: false, feedbackMessage: '', feedbackHistory: [] };
