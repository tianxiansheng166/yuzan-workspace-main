...
| CP5 four entries               | IN_PROGRESS | pending WIP commit                      | shared four-entry navigation implemented; contract-only membership roles restored; 4 files / 22 targeted tests passed; web typecheck exit 0 with existing Volar warning |
