...
report={'viewport': list(ref.size), 'mae': round(mae,3), 'rmse': round(rmse,3), 'note': 'Reference includes rasterized original design content; implementation rebuilds editable UI with HTML/CSS/JS.'}
