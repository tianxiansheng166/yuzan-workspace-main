...
its reference key is A; QB-007 preserves this source mismatch and reports the
actual runtime score. Local speech diagnostics remain experimental and do not
reproduce the authored Level 1 four-point rubric as formal automatic scoring.
